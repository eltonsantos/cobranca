...
def cadpessoas(request):
	template_name = "cadastro/cadastro-pessoas.html"
	context = {}
	if request.method == "POST":
...
def visualizar(request):
	...
	return render(request, "cadastro/visualizar-cadastrados.html", context)
	#template_name = "cadastro/visualizar-cadastrados.html"
	#context = {}
	#pessoa = Pessoa.objects.all()
	#context['pessoa'] = pessoa
	#return render(request, template_name, context)
