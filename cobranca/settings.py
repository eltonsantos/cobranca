...
#        'NAME': 'cobranca.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '4z(@2lc75axyb2f0e8_*(smg94=)^i5%p3lt-k840vtdol@_w0'
...
#GEOS_LIBRARY_PATH = '/usr/local/lib/libgeos-3.3.5.so'
